...
const Portfolio: React.FC = () => {
  return (
    <section className="py-[120px] bg-bg" id="portfolio" aria-label="Latest works">
      <div className="wrap">
        <div className="mb-[60px]">
          <span className="eyebrow-pill reveal mb-5"><span className="dot"></span> Portfolio</span>
          <h2 className="font-display text-[clamp(40px,5vw,54px)] font-normal tracking-[-0.03em] m-0 reveal">Latest Works</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-[100px]">
          {portfolioItems.map((item, i) => (
            <a 
              key={i} 
              href="#contact" 
              className="group flex flex-col bg-bg-card rounded-md overflow-hidden no-underline transition-all duration-300 hover:-translate-y-2 hover:shadow-xl reveal" 
        ...
        <div className="bg-ink text-white rounded-[24px] p-10 md:p-[80px] flex flex-col items-center text-center reveal" id="cta">
